...
CONTAINS
   ...
   SUBROUTINE p4z_prod( kt , knt )
      ...
      CALL p4z_growthSOG(zz_NO, zz_NH, zz_Si, zz_P_diat, zz_I_par_diat, zz_temp, zz_rate_R_diat, zz_rate_maxtemp_diat, &
        ...
        zz_rate_kapa_diat, zz_rate_k_diat, zz_rate_Si_ratio_diat, zz_plank_growth_diat, zz_uptake_NO_diat, zz_micro_Nlimit)
      !M. rubrum:
      CALL p4z_growthSOG(zz_NO, zz_NH, zz_Si, zz_P_myri, zz_I_par_myri, zz_temp, zz_rate_R_myri, zz_rate_maxtemp_myri, &
        ...
        zz_rate_kapa_myri, zz_rate_k_myri, zz_rate_Si_ratio_myri, zz_plank_growth_myri, zz_uptake_NO_myri, zz_dummy)
      !nano/pico:
      CALL p4z_growthSOG(zz_NO, zz_NH, zz_Si, zz_P_nano, zz_I_par_nano, zz_temp, zz_rate_R_nano, zz_rate_maxtemp_nano, &
        ...
        zz_rate_kapa_nano, zz_rate_k_nano, zz_rate_Si_ratio_nano, zz_plank_growth_nano, zz_uptake_NO_nano, zz_dummy)
...
!CDIR NOVERRCHK
      ...
      CALL iom_put( "PPDIAT",zz_plank_growth_diat * zz_P_diat) ! Diatom primary productivity (uM N/s)
      CALL iom_put( "PPPHY",zz_plank_growth_nano * zz_P_nano) ! Small phyto primary productivity (uM N/s)
      CALL iom_put( "PPMRUB",zz_plank_growth_myri * zz_P_myri) ! M. Rubrum primary productivity (uM N/s)
      CALL iom_put( "PPDIATNO3",zz_uptake_NO_diat) ! Diatom new primary productivity (uM N/s)
      CALL iom_put( "PPPHYNO3",zz_uptake_NO_nano) ! Small phyto new primary productivity (uM N/s)
      CALL iom_put( "PPMRUBNO3",zz_uptake_NO_myri) ! M. Rubrum new primary productivity (uM N/s)
   ...
   SUBROUTINE p4z_growthSOG(zz_NO, zz_NH, zz_Si, zz_P, zz_I_par, zz_temp, zz_rate_R, zz_rate_maxtemp, &
        ...
        zz_rate_kapa, zz_rate_k, zz_rate_Si_ratio, zz_plank_growth, zz_uptake_NO, zz_plank_Nlimit)
     ...
     REAL(wp), INTENT(out), DIMENSION(jpi,jpj,jpk)   :: zz_plank_growth, zz_uptake_NO, zz_plank_Nlimit ! 3d output arrays
     ...
     CALL wrk_alloc( jpi, jpj, jpk,  zz_uptake_NH)
     !, zz_uptake_PC
   ...
   ! Computation of SOG limitation terms: light, nutrients
         ...
         DO jj = 1, jpj
           DO ji =1, jpi
                  ...
                  ELSE
                     ...
                     ELSE
                        ...
                        IF (zz_plank_growth(ji,jj,jk) <= &
                           ...
                           zz_uptake_NH(ji,jj,jk) = zz_plank_growth(ji,jj,jk) * &
                                zz_P(ji,jj,jk) !+ zz_uptake_NH(ji,jj,jk)
                           zz_uptake_NO(ji,jj,jk) = 0.0_wp !zz_uptake_NO(ji,jj,jk)

                        ELSE
                           zz_uptake_NH(ji,jj,jk) = zz_Rmax(ji,jj,jk) * &
                                zz_Hup_cell(ji,jj,jk) * zz_P(ji,jj,jk) !+ zz_uptake_NH(ji,jj,jk)
                           zz_uptake_NO(ji,jj,jk) = (zz_plank_growth(ji,jj,jk) - &
                                zz_Rmax(ji,jj,jk) * zz_Hup_cell(ji,jj,jk)) &
                                * zz_P(ji,jj,jk) !+ zz_uptake_NO(ji,jj,jk)
                     ...
                     !     * 0.2_wp * zz_P(ji,jj,jk) !+ zz_uptake_PC(ji,jj,jk)
                  ENDIF
           END DO
        END DO
     END DO
     ...
     CALL wrk_dealloc( jpi, jpj, jpk, zz_uptake_NH)
     !, zz_uptake_PC
   ...
   SUBROUTINE p4z_prod_init
      ...
      &        zz_rate_k_nano, &
      &        zz_rate_Si_ratio_diat, zz_rate_Si_ratio_myri, zz_rate_Si_ratio_nano
