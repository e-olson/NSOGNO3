...
!CDIR NOVERRCHK
            DO ji = 1, jpi
               ...
               zprorca(ji,jj,jk) = zz_plank_growth_nano(ji,jj,jk)  * zz_P_nano(ji,jj,jk) 
               zpronew(ji,jj,jk) = zz_uptake_NO_nano(ji,jj,jk)
      ...
      CALL iom_put( "PPPHYNO3V",zz_uptake_NO_nano*cvol) ! Small phyto primary productivity (umol N/s)
