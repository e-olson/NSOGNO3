      ...
      DO jk = 1, jpkm1
         DO jj = 1, jpj
            DO ji = 1, jpi
                ...
                tra(ji,jj,jk,jpzoo) = tra(ji,jj,jk,jpzoo) + (zz_MicroZoo_eat - zz_uZoo_graz_Z(ji,jj,jk)) 
                tra(ji,jj,jk,jpdia) = tra(ji,jj,jk,jpdia) - zz_uZoo_mort_micro(ji,jj,jk) 
                tra(ji,jj,jk,jpphy) = tra(ji,jj,jk,jpphy) - zz_uZoo_mort_pico(ji,jj,jk) 
                tra(ji,jj,jk,jpmes) = tra(ji,jj,jk,jpmes) - zz_uZoo_mort_nano(ji,jj,jk) 
