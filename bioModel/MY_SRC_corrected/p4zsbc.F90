MODULE p4zsbc
   ...
   !! * Module variables
   INTEGER , PARAMETER  :: jp_nriv  = jp_pisces  !: Maximum number of river input fields: treat all pass vars
...
CONTAINS
   ...
   SUBROUTINE p4z_sbc_init
      ...
      NAMELIST/nampissbc/ cn_dir, sn_riverno3, sn_rivernh4, sn_riversil, sn_riverdia,    &
        &                sn_riverphy, sn_rivermes, sn_riverzoo, sn_riverdoc, sn_riverpoc, sn_riverdsi,   &
