...
CONTAINS
   ...
   SUBROUTINE p4z_nano
      ...
      DO jk = 1, jpkm1
         DO jj = 1, jpj
            DO ji = 1, jpi
               ...
               zz_NatMort_pico(ji,jj,jk) = zz_rate_pico_Rm * tgfunc(ji,jj,jk) * trn(ji,jj,jk,jpphy) 
      ...
      CALL iom_put( "MORTPHY", zz_NatMort_pico)
   ...
   SUBROUTINE p4z_myri
      ...
      DO jk = 1, jpkm1
         DO jj = 1, jpj
            DO ji = 1, jpi
               ...
               zz_NatMort_myri(ji,jj,jk) = zz_rate_myri_Rm * tgfunc(ji,jj,jk) * trn(ji,jj,jk,jpmes) 
      ...
      END DO
      !
      CALL iom_put( "MORTMRUB", zz_NatMort_myri)
   ...
   SUBROUTINE p4z_diat
      ...
      DO jk = 1, jpkm1
         DO jj = 1, jpj
            DO ji = 1, jpi
               ...
               zz_NatMort_micro(ji,jj,jk) = zz_rate_micro_Rm * tgfunc(ji,jj,jk)*trn(ji,jj,jk,jpdia) 
      ...
      CALL iom_put( "MORTDIAT", zz_NatMort_micro)
      !
      IF(ln_ctl)   THEN  ! print mean trends (used for debugging)
