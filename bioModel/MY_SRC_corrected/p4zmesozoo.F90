      ...
      DO jk = 1, jpkm1
         DO jj = 1, jpj
            DO ji = 1, jpi
                ...
                tra(ji,jj,jk,jpdia) = tra(ji,jj,jk,jpdia) - zz_Meso_mort_micro(ji,jj,jk) 
                tra(ji,jj,jk,jpmes) = tra(ji,jj,jk,jpmes) - zz_Meso_mort_nano(ji,jj,jk) 
                tra(ji,jj,jk,jpphy) = tra(ji,jj,jk,jpphy) - zz_Meso_mort_pico(ji,jj,jk) 
