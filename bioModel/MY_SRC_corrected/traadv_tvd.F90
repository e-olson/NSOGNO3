      ...
      DO jn = 1, kjpt                                            ! tracer loop
         ...
         IF( l_trd )  THEN 
            ...
            IF( ( cdtype == 'TRC') .AND. (jn==jpno3)) THEN
               IF( iom_use("NO3TVDX")) THEN
                  CALL iom_put("NO3TVDX",ztrdx*umask)
               ENDIF
               IF( iom_use("NO3TVDY")) THEN
                  CALL iom_put("NO3TVDY",ztrdy*vmask)
               ENDIF
               IF( iom_use("NO3TVDZ")) THEN
                  CALL iom_put("NO3TVDZ",ztrdz*wmask)
               ENDIF
            ENDIF
            IF( ( cdtype == 'TRC') ) THEN
